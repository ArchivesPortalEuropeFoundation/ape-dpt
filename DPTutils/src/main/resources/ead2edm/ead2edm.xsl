    ...
    <xsl:template match="c">
        ...
        <xsl:if test="not(did/dao) and descendant::did/dao">
                                            ...
                                            <!--<xsl:when test="$positionChain">-->
                                                <!--<xsl:call-template name="number">-->
                                                    <!--<xsl:with-param name="prefix"-->
                                                        <!--select="concat($id_base, normalize-space(/ead/eadheader/eadid), '/position/', $positionChain, '-')"/>-->
                                                    <!--<xsl:with-param name="node" select="."/>-->
                                                <!--</xsl:call-template>-->
                                            <!--</xsl:when>-->
                                            <!--<xsl:otherwise>-->
            ...
            <!--<edm:ProvidedCHO>-->
                ...
                <!--<xsl:if test="./scopecontent[@encodinganalog='summary']">-->
                    <!--<dc:description>-->
                        <!--<xsl:value-of select="./scopecontent[@encodinganalog='summary']"/>-->
                    <!--</dc:description>-->
                <!--</xsl:if>-->
                <!--<xsl:if test="$idSource = 'unitid' and did/unitid[@type='call number']">-->
                    <!--<dc:identifier>-->
                        <!--<xsl:value-of select="did/unitid[@type='call number']"/>-->
                    <!--</dc:identifier>-->
                <!--</xsl:if>-->
                <!--<xsl:if test="$idSource = 'cid' and @id">-->
                    <!--<dc:identifier>-->
                                ...
                                <!--<xsl:attribute name="rdf:resource">-->
                                    <!--<xsl:call-template name="number">-->
                                        ...
                                        <!--<xsl:with-param name="node"-->
                                            <!--select="./preceding-sibling::*[descendant::did/dao][1]"-->
                                        <!--/>-->
                                    <!--</xsl:call-template>-->
                                <!--</xsl:attribute>-->
                            <!--</edm:isNextInSequence>-->
            ...
            <!--<edm:WebResource>-->
                ...
                <!--</dc:description>-->
 				<!--<edm:rights rdf:resource="http://creativecommons.org/publicdomain/zero/1.0/"/>-->
            <!--</edm:WebResource>-->
            <!--<po2><xsl:value-of select="$positionChain"/></po2>-->
            <!--<po3><xsl:value-of select="$positionInDocument"/></po3>-->
