...
public class EacCpfRelationsPanel extends EacCpfPanel {
	 ...
	 * @param labels
	 */
	public EacCpfRelationsPanel(EacCpf eaccpf, JTabbedPane tabbedPane, JTabbedPane mainTabbedPane, JFrame eacCpfFrame, ProfileListModel model, ResourceBundle labels) {
	...
	protected JComponent buildEditorPanel(List<String> errors) {
		...
		this.rowNb = 1;
		builder.addLabel("Relations tab",    cc.xy (1, this.rowNb));
