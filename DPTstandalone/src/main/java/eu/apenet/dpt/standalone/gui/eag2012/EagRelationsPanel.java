...
public class EagRelationsPanel extends EagPanels {
    ...
    public EagRelationsPanel(Eag eag, JTabbedPane tabbedPane, JTabbedPane mainTabbedPane, JFrame eag2012Frame, ProfileListModel model, ResourceBundle labels) {
    ...
    public class AddResourceRelationAction extends UpdateEagObject {
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            ...
            reloadTabbedPanel(new EagRelationsPanel(eag, tabbedPane, mainTabbedPane, eag2012Frame, model, labels).buildEditorPanel(errors), 6);
        }
    }
