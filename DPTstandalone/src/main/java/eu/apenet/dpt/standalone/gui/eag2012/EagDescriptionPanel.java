...
//            }
        ...
        previousTabBtn.addActionListener(new EagDescriptionPanel.ChangeTabBtnAction(false));

        if(repositoryNb == 0) {
            JButton nextTabBtn = new ButtonEag(labels.getString("eag2012.nextTabButton"));
            builder.add(nextTabBtn, cc.xy(5, rowNb));
            nextTabBtn.addActionListener(new EagDescriptionPanel.ChangeTabBtnAction(true));
        }
