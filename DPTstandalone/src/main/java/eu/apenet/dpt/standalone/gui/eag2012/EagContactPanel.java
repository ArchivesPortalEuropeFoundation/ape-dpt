...
public class EagContactPanel extends EagPanels {
    ...
    public EagContactPanel(Eag eag, JTabbedPane tabbedPane, JTabbedPane mainTabbedPane, JFrame eag2012Frame, ProfileListModel model, ResourceBundle labels) {
    ...
    public class SaveBtnAction extends UpdateEagObject {
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            try {
                ...
                reloadTabbedPanel(new EagContactPanel(eag, tabbedPane, mainTabbedPane, eag2012Frame, model, labels).buildEditorPanel(errors), 0);
            }
        }
    }
